...
public class StudentController {
    ...
    public ResponseEntity<List<StudentResponseDto>> getStudentsByViolation(@PathVariable ViolationType type){
    ...
    @PostMapping("/{roomId}")
    public ResponseEntity<StudentResponseDto> createStudent(@PathVariable Long roomId, @RequestBody StudentRequestDto student){
        StudentResponseDto newStudent = studentService.createStudent(roomId,student);
        return new ResponseEntity<>(newStudent, HttpStatus.CREATED);
    }

    @PutMapping("/{id}")
    public ResponseEntity<StudentResponseDto> updateStudentById(@PathVariable Long id,@RequestBody StudentRequestDto student){
        return ResponseEntity.ok(studentService.updateStudent(id,student));
    }

    @PatchMapping("/{id}")
    public ResponseEntity<StudentResponseDto> updatePatchStudentById(@PathVariable Long id,@RequestBody StudentRequestDto student){
    ...
    @PostMapping("/noTx")
    public ResponseEntity<StudentResponseDto> createStudentWoTx(@RequestBody StudentCreationDto student){
        try {
    ...
    @PostMapping("/withTx")
    public ResponseEntity<StudentResponseDto> createStudentWithTx(@RequestBody StudentCreationDto student){
        try {
