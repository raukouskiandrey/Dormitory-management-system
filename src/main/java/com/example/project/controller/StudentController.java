...
public class StudentController {
    ...
    @GetMapping("/all")
    @Operation(summary = "Список всех студентов (пагинация)", description = "Возвращает страницу со списком всех студентов")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Найти студента по ID", description = "Возвращает информацию о студенте")
    ...
    @GetMapping("")
    @Operation(summary = "Поиск студентов по возрасту", description = "Возвращает список студентов определенного возраста")
    ...
    @Operation(summary = "Заселить студента в комнату", description = "Устанавливает связь между студентом и комнатой")
    ...
    @Operation(summary = "Привязать нарушение к студенту", description = "Добавляет существующее нарушение в список нарушений студента")
    ...
    @PostMapping("/{roomId}")
    @Operation(summary = "Простое создание студента", description = "Создает студента и сразу прикрепляет его к комнате")
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Полное обновление студента", description = "Обновляет все данные студента по ID")
    ...
    @PatchMapping("/{id}")
    @Operation(summary = "Частичное обновление студента", description = "Обновляет только присланные поля студента")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Удалить студента", description = "Удаляет студента и связанные с ним данные")
    ...
    @PostMapping("/noTx")
    @Operation(summary = "Создание без транзакции (тест)", description = "Метод для демонстрации проблем с целостностью данных без @Transactional")
    ...
    @PostMapping("/withTx")
    @Operation(summary = "Комплексное создание (Transactional)", description = "Метод для демонстрации проблем с целостностью данных с @Transactional")
    ...
    @Operation(summary = "Фильтр JPQL", description = "Сложный поиск по часам ОПТ и типу нарушения через JPQL")
    ...
    @Operation(summary = "Фильтр Native SQL", description = "Сложный поиск по часам ОПТ и типу нарушения через native")
