...
public class ContractController {
    ...
    public ResponseEntity<ContractResponseDto> createContract(@PathVariable Long studentId,@RequestBody ContractRequestDto contract){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ContractResponseDto> updateContractById(@PathVariable Long id,@RequestBody ContractRequestDto contract){
        return ResponseEntity.ok(contractService.updateContract(id,contract));
    }

    @PatchMapping("/{id}")
    public ResponseEntity<ContractResponseDto> updatePatchContractById(@PathVariable Long id,@RequestBody ContractRequestDto contract){
